  ...
  // Sample data - you'll replace this with your actual projects
  const projectsData = [
    {
      id: '1',
      name: 'Project Cosmos',
      description: 'A space exploration app',
      planetImage: '/planets/planet1.png',
      techStack: ['React', 'TypeScript', 'Three.js'],
      previewContent: {
        title: 'Project Cosmos - Space Exploration',
        description: 'Interactive 3D visualization of the solar system',
        features: ['Real-time 3D rendering', 'Interactive planets', 'Educational content']
      }
    },
    // Add more projects...
  ];
    ...
    return (
      <section className="relative min-h-screen bg-background-primary dark:bg-background-primary-dark transition-colors duration-300 overflow-hidden">
        ...
        >
          ...
          <PlanetSystem projects={projectsData} />
        </motion.div>
      </section>
    );
  };
