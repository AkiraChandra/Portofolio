...
const ProgressLine: React.FC<ProgressLineProps> = ({
  ...
  return (
    <div className="relative flex items-center h-0.5 w-full">
      {/* Base Line */}
      <div className="absolute w-full h-full bg-border-primary/20 dark:bg-border-primary-dark/20 rounded-full" />
      ...
      <motion.div
        ...
        className="absolute h-full rounded-full bg-gradient-to-r from-primary via-primary to-primary-dark 
