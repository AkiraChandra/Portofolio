  ...
  return (
    <section className="relative min-h-screen bg-background-primary dark:bg-background-primary-dark transition-colors duration-300 overflow-hidden pt-16 sm:pt-20 lg:pt-0">
              ...
              <div className="flex-1 max-w-[560px] xl:max-w-[640px]">
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-6 sm:px-8 py-2.5 sm:py-3 lg:px-8 xl:px-10 lg:py-3 xl:py-4 bg-primary dark:bg-primary-dark text-background-primary dark:text-background-primary-dark rounded-lg hover:bg-primary-dark dark:hover:bg-primary transition-colors duration-300 flex items-center gap-2 text-sm sm:text-base lg:text-lg"
                  >
                    Let's Connect
                    <svg
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 sm:px-8 py-2.5 sm:py-3 lg:px-8 xl:px-10 lg:py-3 xl:py-4 border border-text-primary/20 dark:border-text-primary-dark/20 text-primary dark:text-primary-dark rounded-lg hover:bg-background-secondary dark:hover:bg-background-secondary-dark transition-colors duration-300 text-sm sm:text-base lg:text-lg"
                  >
                    Download CV
                  </motion.button>
                </motion.div>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-text-tertiary dark:text-text-tertiary-dark transition-colors duration-300"
      >
