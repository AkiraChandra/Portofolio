            ...
            <div className="md:flex md:items-center">
              ...
              <div className="flex-1 max-w-[560px] xl:max-w-[640px]">
                ...
                <motion.div
                  ...
                  className="lg:hidden bg-purple-800/20 text-text-primary dark:text-text-primary-dark px-4 py-1.5 sm:px-5 sm:py-2 rounded-lg inline-block mb-3 backdrop-blur-sm text-sm sm:text-base mt-4"
                >
