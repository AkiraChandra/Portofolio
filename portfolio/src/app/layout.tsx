...
export const metadata: Metadata = {
  ...
  description: "Full Stack Developer specializing in modern web technologies and creative solutions. Experienced in React, Next.js, TypeScript, and mobile development.",
  keywords: [
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="preconnect" href="https://xzuzvdjronzjybrbgsct.supabase.co" crossOrigin="anonymous" />
        ...
        {/* OPTIMIZATION 5: Preload critical CSS - Fixed for Next.js 13+ */}
        <link
          rel="preload"
