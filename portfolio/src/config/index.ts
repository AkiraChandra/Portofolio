...
export const getCssVariables = (isDark: boolean = false): CSSVariables => ({
  '--background': isDark ? config.theme.colors.background.dark : config.theme.colors.background.light,
  '--foreground': isDark ? config.theme.colors.text.dark : config.theme.colors.text.light,
  '--glow-text': isDark ? config.theme.colors.glow.dark : config.theme.colors.glow.light,
